...
namespace Core.Utilities.ConfirmMessageSend
{
    public static class EmailConfirme
	{

        public static bool SendEmail(string userEmail, string confirmationLink,string UserName,string fromEmail,string fromEmailPassword,string serviceName,int servicePort)
        {
            ...
            smtp.Connect(serviceName, servicePort, MailKit.Security.SecureSocketOptions.StartTls);
